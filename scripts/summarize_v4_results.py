...
def main() -> int:
    parser = argparse.ArgumentParser(description="Summarize synced v4 walk-forward and backtest reports.")
    parser.add_argument("--run-tags", nargs="+", default=["mh12_full_v4", "mh12_recent_v4"])
    ...
    json_path = EVAL_DIR / "v4_summary.json"
    md_path = EVAL_DIR / "v4_summary.md"
