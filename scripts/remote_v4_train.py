...
def main() -> int:
    ...
    steps = [
        ("download_core_datasets", [PYTHON, "scripts/download_core_datasets.py", "--category", "all", "--workers", "12", "--allow-errors"]),
    ...
    print("\n===== v4 pipeline complete =====", flush=True)
    return 0
