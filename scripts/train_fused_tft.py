...
def main() -> int:
    ...
    summary = {
        ...
        'market_dynamics_labels_path': str(MARKET_DYNAMICS_LABELS_PATH if MARKET_DYNAMICS_LABELS_PATH.exists() else MARKET_DYNAMICS_LABELS_PATH.with_suffix('.csv') if MARKET_DYNAMICS_LABELS_PATH.with_suffix('.csv').exists() else ''),
