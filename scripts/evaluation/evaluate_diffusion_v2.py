...
def _run_phase05_eval(device: torch.device) -> dict:
    ...
    if "temporal_encoder" in ckpt:
        ...
        print("WARNING: No temporal_encoder in checkpoint â€” using random init")
...
def _print_comparison(phase0: dict, phase05: dict) -> None:
    ...
    if targets_met == targets_total:
        print("  >>> ALL TARGETS MET â€” ready for V26 Phase 1 (regime threading)")
    else:
        print("  >>> NOT ALL TARGETS MET â€” further tuning required")
