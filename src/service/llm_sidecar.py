...
NUMERIC_FIELD_MEANINGS: dict[str, str] = {
    ...
    "v21_runtime.should_execute": "Whether the local V21 runtime would actually execute the current bar after its safety gates.",
    "v21_runtime.v21_dir_15m_prob": "xLSTM 15-minute directional probability from the local V21 runtime.",
    "v21_runtime.v21_bimamba_prob": "BiMamba 15-minute directional probability from the local V21 runtime.",
    "v21_runtime.v21_ensemble_prob": "Blended V21 directional probability after combining xLSTM and BiMamba.",
    "v21_runtime.v21_meta_label_prob": "Execution probability after V21 meta-label style aggregation.",
    "v21_runtime.v21_disagree_prob": "Model disagreement level between xLSTM and BiMamba in the V21 runtime.",
    "v21_runtime.v21_dangerous_branch_count": "Count of highly ranked branches that contradict the chosen direction.",
    "v21_runtime.lepl_features.kelly_fraction": "Kelly-style fractional size suggestion before hard lot caps.",
    "v21_runtime.lepl_features.suggested_lot": "Local V21 lot suggestion before broker clamp logic.",
    "v21_runtime.lepl_features.conformal_confidence": "Conformal confidence used by the local V21 execution gate.",
    "live_performance.balance": "Current paper or live balance carried in the desk state.",
    "live_performance.equity": "Current paper or live equity after unrealized PnL.",
    "live_performance.rolling_win_rate_10": "Recent hit rate over the last 10 closed trades.",
    "live_performance.consecutive_losses": "Current closed-trade losing streak.",
    "live_performance.daily_pnl": "Closed-trade PnL accumulated for the current UTC day.",
    "v22_runtime.online_hmm.regime_confidence": "Confidence of the streaming V22 regime detector for the active HMM state.",
    "v22_runtime.online_hmm.persistence_count": "Number of consecutive bars spent in the current online HMM regime.",
    "v22_runtime.online_hmm.lot_size_multiplier": "Lot-size multiplier imposed by the V22 regime-confidence guard.",
    "v22_runtime.circuit_breaker.size_multiplier": "Execution size multiplier imposed by the V22 circuit breaker.",
    "v22_runtime.circuit_breaker.rolling_win_rate_10": "Rolling win rate tracked directly by the V22 circuit breaker.",
    "v22_runtime.circuit_breaker.daily_drawdown_pct": "Current daily drawdown percentage tracked by the V22 circuit breaker.",
    "v22_runtime.ensemble.agreement_rate": "Fraction of V22 student judges aligned on the chosen direction.",
    "v22_runtime.ensemble.meta_label_prob": "V22 meta-label filter probability that the trade should be executed.",
    "v22_runtime.ensemble.risk_score": "Average risk-head output across the V22 student ensemble.",
    "v22_runtime.ensemble.conformal_set_size": "Size of the conformal prediction set after V22 ensemble calibration.",
    "v22_runtime.risk_check.rr_ratio": "Projected reward-to-risk ratio after V22 stop-loss and take-profit placement.",
...
def build_numeric_glossary(context: Mapping[str, Any]) -> dict[str, dict[str, Any]]:
    ...
    for path, value in _flatten_numeric_paths(context):
        glossary[path] = {
            ...
            "meaning": NUMERIC_FIELD_MEANINGS.get(path, f"Numeric Nexus context value carried under `{path}`."),
        }
    return glossary
